...
if($operation=='check_user_duplicacy'){
    $db_field = ($field=='user_email') ? 'user_email' : 'user_name';
    $count = $obj->Total_Count_By_Cond("web_user","$db_field='$value' AND active_flag='1'");
    echo $count;
}

else if($operation=='user_save'){
    ...
    $values = array(
        ...
        'user_role_ref'=>$user_role,
        'active_flag'=>$user_active_flag,
        'create_by'=>1,
        'create_date'=>$date
    );
