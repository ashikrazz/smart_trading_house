function show_datatable(){
    $("#contentWrapper").load("contents/sales_datatable.php");
}
        ...
        $.ajax({
            ...
            success: function(php_script_response){
                if(php_script_response=='Success'){
                    ...
                    toastr.error("Sorry Sales Failed to Add. Please Try Again");
                }
            }
        });
    }
        ...
        $.ajax({
            ...
            success: function(php_script_response){
                if(php_script_response=='Success'){
                    ...
                    toastr.error("Sorry Sales Failed to Update. Please Try Again");
                }
            }
        });
    }
...
function publish(id){
    ...
    $.ajax({
        ...
        success: function(php_script_response){
            if(php_script_response=='Success'){
                toastr.success("Sales Published Successfully");
                $("#contentWrapper").load("contents/user_datatable.php");
            } else {
                toastr.error("Sorry Sales Failed to Publish. Please Try Again");
            }
        }
    });
}
...
function unpublish(id){
    ...
    $.ajax({
        ...
        success: function(php_script_response){
            if(php_script_response=='Success'){
                toastr.success("Sales Unpublished Successfully");
                $("#contentWrapper").load("contents/user_datatable.php");
            } else {
                toastr.error("Sorry Sales Failed to Unpublish. Please Try Again");
            }
        }
    });
}
    ...
    $.ajax({
        ...
        success: function(php_script_response){
            if(php_script_response=='Success'){
                ...
                toastr.error("Sorry Sales Failed to Delete. Please Try Again");
            }
        }
    });
}