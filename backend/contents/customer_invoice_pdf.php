...
/* =========================
   FETCH DATA
========================= */
$invoice = $obj->Details_By_Cond("customer_purchase_invoice", "id='$id'");
$invoice_id   = $invoice['id'];
$invoice_no   = $invoice['invoice_no'];
$invoice_date = date('l, F j, Y', strtotime($invoice['purchase_date']));

$supplier = $obj->Details_By_Cond("web_user", "id='{$invoice['customer_id']}'");

$payment_info = $obj->Details_By_Cond("customer_sale_payments", "invoice_id='$invoice_id'");
...
?>
    ...
    <div class="page">
        ...
        <table class="table">
            ...
            foreach ($obj->View_All_By_Cond("customer_sale_items", "invoice_id='$invoice_id'") as $item):
            ...
            <tr>
                <td width="60%">
                    ...
                    <table class="table payment">
                        ...
                        <?php
                        $p = 1;
                        foreach ($obj->View_All_By_Cond("customer_sale_payments", "invoice_id='$invoice_id'") as $pay):
                            ?>
                            <tr>
                                <td><?= $p++ ?></td>
                                <td><?= $pay['method'] ?></td>
                ...
                <td width="40%" class="right">
                    <div class="totals">
                        ...
                        <div class="due">Change : <?= abs(number_format($payment_info['change'],2)) ?> BDT</div>
                    </div>
                </td>
            </tr>
        </table>
