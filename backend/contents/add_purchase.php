...
$obj = new my_class();
$invoice_no = "INVS-" . date('Ymd') . rand(1000, 9999);
?>
<!-- Page wrapper  -->
<!-- ============================================================== -->
    ...
    <div class="container-fluid">
        ...
        <div class="row page-titles">
            <div class="col-md-5 align-self-center">
                <h4 class="text-themecolor">Add Purchase</h4>
            </div>
            <div class="col-md-7 align-self-center text-end">
                <div class="d-flex justify-content-end align-items-center">
                    ...
                    <button type="button" class="btn btn-info d-none d-lg-block m-l-15 text-white" onclick="window.location.href='?page=add_supplier'"><i class="fa fa-plus-circle"></i> Create New Supplier</button>
                </div>
            </div>
        </div>
        <!-- ============================================================== -->
                        ...
                        <div class="row">
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="exampleInputInvoice" aria-describedby="invoiceHelp" value="<?= $invoice_no ?>" readonly style="background:#e9ecef; font-weight:500;">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <select class="select2 form-control form-select" aria-describedby="customerHelp" style="width: 100%;" id="exampleInputCustomer">
                                        ...
                                        <?php
                                        foreach($obj->View_All_By_Cond("web_user","active_flag=1 AND user_type_ref=2") as $value){
                                            echo "<option value='".$value['id']."'>".$value['user_profile_name']."-".$value['user_phone']."</option>";
                                        }
                                        ?>
                                    </select>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="select2 form-control form-select" style="width: 100%;" id="category_id">
                                            ...
                                            foreach($obj->View_All_By_Cond("web_product_type","active_flag=1") as $v){
                                                echo "<option value='".$v['id']."'>".$v['product_type_title']."</option>";
                                            }
                                            ?>
                                        </select>
                                    </div>
                            ...
                            <div class="row">
                                <div class="col-md-2">
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control" id="exampleInputQuantity" value="0" step="1.00">
                                    </div>
                                </div>
                        ...
                        <div class="row g-4">
                            ...
                            <div class="col-md-8">
                                ...
                                <div class="row g-3">
                                    ...
                                    <div class="col-md-3"><input id="payment_date" type="date" class="form-control" value="<?=date('Y-m-d')?>"></div>
                            ...
                            <div class="col-md-4">
                                <div class="p-3 rounded-lg shadow" style="background:#f8fafc">
                                    ...
                                    <div class="d-flex justify-content-between text-danger fw-bold py-1"><span>Total Due:</span><span id="summary_balance"></span></div>
...
<script>
    ...
    $(document).ready(function () {
        ...
        $('#category_id').on('select2:select', function () {
            ...
            let category_id = $(this).val();
            console.log("Category id for VAT:", category_id);
...
<script>
    $(document).ready(function(){
        ...
        $(".btn-success.mt-4").click(function(){
            ...
            if(!productName || !variantName || qty <= 0){
        ...
        function calculateSummary(){
            ...
            $tableBody.find("tr").each(function(){
                total += parseFloat($(this).find("td:eq(8)").text()) || 0; // Total column
                totalVat += parseFloat($(this).find("td:eq(6)").text()) || 0; // Vat column
            });

            $("#summary_total").text(total.toFixed(2) + " ৳");
            $("#summary_vat").text(totalVat.toFixed(2) + " ৳");
            $("#summary_grand").text(total.toFixed(2) + " ৳");
            ...
            $("#summary_balance").text((total - paid).toFixed(2) + " ৳");
        }
    ...
    $("#saveInvoiceBtn").click(function(){
        ...
        $(".table.color-table.success-table tbody tr").each(function(){
            ...
            items.push({
                ...
                qty: parseFloat(tds.eq(3).text()),
                price: parseFloat(tds.eq(4).text()),
                subtotal: parseFloat(tds.eq(5).text()),
                vat: parseFloat(tds.eq(6).text()),
                vat_percent: parseFloat(tds.eq(7).text()),
                total: parseFloat(tds.eq(8).text())
            });
        });
        ...
        $(".table.color-table.info-table tbody tr").each(function(){
            let tds = $(this).find("td");
            payments.push({
                method: tds.eq(1).text(),
                amount: parseFloat(tds.eq(2).text()),
                date: tds.eq(3).text(),
                notes: tds.eq(4).text()
            });
        });
        ...
        $.ajax({
            url: "functions/save_invoice.php",
            method: "POST",
            data: {
                invoice_no, note, supplier_id, purchase_date,
                items: JSON.stringify(items),
                payments: JSON.stringify(payments)
            },
            success: function(res){
                if(res.status=="success"){
                    window.open("contents/view_invoice.php?id="+res.invoice_id,"_blank");
                    location.reload();
                }else{
                    alert(res.message);
                }
            ...
            error: function(){
                alert("AJAX error while saving invoice.");
            }
        });
    });
