...
$id = isset($id) ? $id : '';
if ($id != ""){
    $web_product_subtype_info = $obj->Details_By_Cond("variant", "id='$id'");
    ...
    <div class="container-fluid">
        ...
        <div class="row page-titles">
            <div class="col-md-5 align-self-center">
                <h4 class="text-themecolor">Add Variant </h4>
            </div>
            <div class="col-md-7 align-self-center text-end">
                <div class="d-flex justify-content-end align-items-center">
                    ...
                    <button type="button" class="btn btn-info d-none d-lg-block m-l-15 text-white"
                            onclick="window.location.href='?page=manage_variant'">
                        <i class="fas fa-binoculars"></i> View All Variant
                    </button>
                </div>
            </div>
        </div>
                    ...
                    <div class="card-body">
                        ...
                        <form id="variantForm">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3" id="product_id_wrapper">
                                ...
                                <div class="col-md-3" id="variant_type_id_wrapper">
                                    <div class="form-group">
                                        <label>Variant Type</label>
                                        <select class="form-control" id="variant_type_id" name="variant_type_id">
                                            <option value="">-- Select Variant Type --</option>
                                            <?php
                                            foreach ($obj->View_All_By_Cond("variant_type","active_flag=1") as $row) {

                                                $selected = (!empty($variant_type_ref) && $variant_type_ref == $row['id'])
                                                    ? "selected='selected'"
                                                    : "";
                                ...
                                <div class="col-md-3" id="variant_wrapper">
                                    <div class="form-group">
                                        <label>Variant </label>
                                        <input type="text" class="form-control" id="variant" name="variant" value="<?php echo $name?>">
                                    </div>
                                </div>
                            ...
                            <?php if ($id != ""){ ?>
                                ...
                                <button type="button" onclick="update_variant(<?php echo $id?>)" class="btn btn-primary mt-3">Update Variant </button>
                            <?php } else { ?>
                                <button type="button" onclick="save_variant()" class="btn btn-primary mt-3">Save Variant </button>
                            <?php } ?>
...
<script>
    document.addEventListener("DOMContentLoaded", function () {
        ...
        const firstField = document.getElementById("product_id");
        if (firstField) {
            firstField.focus();
        ...
        document.addEventListener("keydown", function (e) {
            ...
            if (!active.closest("#variantForm")) return;
    ...
    function submitVariantForm() {
        ...
        if (variantId) {
            update_variant(variantId.value);
        } else {
            save_variant();
        }
    }
