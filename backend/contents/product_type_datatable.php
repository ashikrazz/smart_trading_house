...
<div class="container-fluid">
    ...
    <div class="row page-titles">
        <div class="col-md-5 align-self-center">
            <h4 class="text-themecolor">Manage Products Type</h4>
        </div>
        <div class="col-md-7 align-self-center text-end">
            <div class="d-flex justify-content-end align-items-center">
                ...
                <button type="button" class="btn btn-info d-none d-lg-block m-l-15 text-white" onclick="window.location.href='?page=add_product_type'"><i class="fa fa-plus-circle"></i> Add Product Type</button>
            </div>
        </div>
    </div>
    <!-- ============================================================== -->
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table product-overview" id="myTable">
                            ...
                            <?php
                            $s=1;
                            foreach ($obj->View_All_By_Cond("web_product_type","active_flag=1 OR active_flag=2") as $value){
                                $id = $value['id'];
                                $name = $value['product_type_title'];
                                $logo = $value['product_type_icon'];
                                $description = $value['product_type_short_desc'];
                                $date = date("Y-m-d", strtotime($value['create_date']));
                                $status = $value['active_flag'];
                                ?>
                                <tr>
                                    <td><?php echo $s;?>.</td>
                                    <td> <img src="../resources/product_type/icon/<?php echo $logo;?>" alt="Brand Logo" width="40" height="40"> </td>
                                    <td><?php echo $name;?></td>
                                    ...
                                    <td>
                                        ...
                                        <?php }?>
                                        <a href="?page=add_product_type&id=<?php echo $id; ?>" class="text-inverse p-r-10 btn btn-success btn-xs" data-bs-toggle="tooltip" title="Edit"><i class="ti-marker-alt"></i>Edit</a>
