...
// Get invoice
$invoice_info = $obj->Details_By_Cond("web_purchase_invoice", "id='$id'");
$invoice_id = $invoice_info['id'];
$invoice_code = $invoice_info['invoice_no'];
$purchase_date = $invoice_info['purchase_date'];
...
<div class="page bg-white shadow-lg p-10">
    ...
    <div class="mt-6">
        <table class="w-full border-collapse text-sm">
            ...
            <?php
                ...
                $invoice_vat = 0;
                $total_payable = 0;
                foreach ($obj->View_All_By_Cond("web_purchase_items","invoice_id = $invoice_id") as $value){
                ...
                <tr>
                    ...
                    <td class="p-2 border"><?php echo $qty?></td>
    ...
    <div class="flex justify-between mt-8">
        <div class="text">
            ...
            <table class="w-full border-collapse text-sm none-border">
                ...
                $y=1;
                $total_paid = 0;
                foreach ($obj->View_All_By_Cond("web_purchase_payments","invoice_id = $invoice_id") as $value){
                $amount = $value['amount'];
        ...
        <div class="text-sm w-60">
            ...
            <?php
                $payment_information = $obj->Details_By_Cond("web_purchase_payments","invoice_id = $invoice_id");
                $total_payable = $payment_information['total_payable'];
                $total_paid = $payment_information['total_paid'];
                $total_due = $payment_information['total_due'];
            ?>
    ...
    <a href="invoice_pdf.php?id=<?php echo $invoice_id; ?>" target="_blank"
