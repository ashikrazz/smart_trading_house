...
?>
<script src="functions/js/sales.js"></script>
<div class="container-fluid">
    ...
    <div class="row page-titles">
        <div class="col-md-5 align-self-center">
            <h4 class="text-themecolor">Manage Sales</h4>
        </div>
        <div class="col-md-7 align-self-center text-end">
            <div class="d-flex justify-content-end align-items-center">
                ...
                <button type="button" class="btn btn-info d-none d-lg-block m-l-15 text-white" onclick="window.location.href='?page=add_sale'"><i
                        class="fa fa-plus-circle"></i> Create New Sales
                </button>
                <button type="button" class="btn btn-success d-none d-lg-block m-l-15 text-white" onclick="window.location.href='?page=sales_report'"><i
                        class="fa fa-binoculars"></i> View Sales Report
                </button>
            </div>
        </div>
    </div>
                    ...
                    <div class="card-body">
                        <div class="right-page-header">
                            <div class="d-flex">
                                <div class="align-self-center">
                                    <h4 class="card-title m-t-10">Sales History </h4>
                                </div>
                                <div class="ms-auto">
                        ...
                        <div class="table-responsive m-t-30">
                            <table class="table product-overview" id="salesTable">
                                ...
                                <?php
                                    $x=1;
                                    foreach ($obj->View_All(" customer_sale_items") as $value){
                                        $id = $value['id'];
                                        $invoice_id = $value['invoice_id'];
                                        $invoice_info = $obj->Details_By_Cond("customer_purchase_invoice","id=$invoice_id");
                                        $invoice_no = $invoice_info['invoice_no'];
                                        $customer_ref = $invoice_info['customer_id'];
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td><?php echo $qty?> <?php echo $unit ?></td>
                                        <td><?php echo $total_amount?>৳</td>
                                        <td><?php echo $date?></td>
                                        <td>
                                            <div class="ms-auto">
                                                <a href="contents/view_customer_invoice.php?id=<?php echo $invoice_id; ?>" target="_blank" class='btn btn-success btn-xs' role="button"><i class='fa fa-binoculars'></i>  View Details</a>
                                            </div>
                                        </td>
                                </tr>
                                <?php $x++; } ?>
